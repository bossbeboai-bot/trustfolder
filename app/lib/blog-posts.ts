...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    tags: ['AI governance checklist', 'ISO/IEC 42001 readiness', 'AI governance policy draft'],
    reading_minutes: 5,
    sections: [
      ...
      { type: 'h2', text: 'How this maps to ISO/IEC 42001 readiness' },
      { type: 'p', text: 'ISO/IEC 42001 is the AI management system standard. You are not certifying anything by writing this checklist. But the structure - inventory, owners, review cadence, evidence - is the same shape. Small teams that start here have less work to do later if certification ever becomes a real requirement.' },
